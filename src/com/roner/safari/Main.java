...
import com.roner.safari.command.GateCommand;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DuckArea duckArea = DuckArea.getInstance();
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                duckArea.updateStatusArea(Math.ceil(Math.random() * 1000), new Random().nextBoolean(),
                        (int) (Math.random() * 100));
                counter++;
                GateCommand.DUCK.execute();
                System.out.println("Duck area gate status: " + (duckArea.isOpenGate() ? "ABERTO" : "FECHADO"));
            }
        };
